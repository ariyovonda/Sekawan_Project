...
const Testimonials = () => {
  ...
  return (
    <section className="py-24 bg-white relative overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-40 bg-gradient-to-b from-financial-50 to-white"></div>
      ...
      <div className="content-section relative z-10">
        <AnimatedSection>
          <div className="text-center mb-16">
            ...
            <h2 className="mb-4 text-financial-900">Apa yang <span className="text-shine">Nasabah Katakan</span></h2>
          ...
          <div className="relative max-w-4xl mx-auto px-4">
            ...
            >
              <div className="mb-6 text-center">
                <div className="mx-auto w-12 h-12 flex items-center justify-center rounded-full bg-financial-100 text-financial-600 mb-6">
                  <Quote className="w-6 h-6" />
                </div>
                <blockquote className="text-xl md:text-2xl font-medium text-financial-800 mb-8">
                  "{testimonials[activeIndex].content}"
                </blockquote>
                <div className="font-semibold text-financial-900">{testimonials[activeIndex].name}</div>
                <div className="text-financial-500 text-sm">{testimonials[activeIndex].role}</div>
              </div>
            </div>
              ...
              {testimonials.map((_, idx) => (
                <button
                  ...
                  className={cn(
                    ...
                    idx === activeIndex ? "bg-financial-600 w-6" : "bg-financial-200"
                  )}
            ...
            <div className="absolute top-1/2 -translate-y-1/2 left-0 right-0 flex justify-between pointer-events-none">
              <button
                ...
                className="w-10 h-10 rounded-full bg-white shadow-md text-financial-700 hover:text-financial-900 flex items-center justify-center transition-colors pointer-events-auto"
